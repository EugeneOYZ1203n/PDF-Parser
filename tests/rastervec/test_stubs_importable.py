"""Sanity checks that the not-yet-implemented Raster/Renderer/helpers
modules import cleanly and raise NotImplementedError on use -- catches
import-time typos before those stages are actually built. Renderer.
render_vector_cluster and RenderOCR (Vector-stage OCR) are implemented,
so they're covered by their own tests instead, not this stub list."""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Renderer(), "render_raster_region", (None, 300)),
