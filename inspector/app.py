...
if __name__ == "__main__" and __package__ is None:
    # Allow running this file directly (`python inspector/app.py`), not
    # just as a module (`python -m inspector.app`), by putting the repo
    # root -- the parent of this package -- on sys.path.
    sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from inspector import pdf_model
from inspector.control_panel import ControlPanel
from inspector.layers import build_layers, filter_items
from inspector.overlay_canvas import PageView
